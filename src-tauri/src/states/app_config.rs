...
impl Default for AppConfig {
    fn default() -> Self {
        ...
        api_configs.insert(ModelProvider::Qwen, APIConfig { api_key: std::env::var("QWEN_API_KEY").unwrap_or_else(|_| "".to_string()), base_url: "https://dashscope.aliyuncs.com".to_string(), model: "qwen-plus".to_string(), index: 1 });
        api_configs.insert(ModelProvider::DeepSeek, APIConfig { api_key: std::env::var("DEEPSEEK_API_KEY").unwrap_or_else(|_| "".to_string()), base_url: "https://api.deepseek.com".to_string(), model: "deepseek-chat".to_string(), index: 2 });
