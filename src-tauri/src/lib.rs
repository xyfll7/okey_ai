...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            my_command::set_prompt_language,
            my_command::get_prompt_tags,
            my_command::delete_prompt_tag,
            my_command::add_prompt_tag,
            my_command::update_prompt_tag,
